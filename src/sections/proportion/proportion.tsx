...
import proportionImg from '@/assets/images/proportion/1.png'
...
import { proportionVariants } from './proportion.variants'
    ...
    <section className={root()}>
      <Container as="div" layout="col" className={wrapper()}>
        <div className={content()}>
          ...
          <div className={media()}>
            <img src={proportionImg} alt="Profissional de segurança" className={image()} />
          </div>
        </div>
